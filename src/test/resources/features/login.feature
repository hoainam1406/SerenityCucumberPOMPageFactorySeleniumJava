Feature: This is test scenario of Login Page
  ...
  Scenario Outline: TC-06 - System navigate to Explore Project page when login successfully
    ...
    Then System navigate to Explore Project page with <URL>
    Examples:
      | email                              | password  |URL |
      | phuongthanhgiang+test999@gmail.com | Giang123@ |https://iresource.smartdev.vn/explore-projects |